  ...
  return (
    <>
      <div className='bg-background-default px-20 py-10 flex flex-col'>
        ...
        <img className='mt-10' src='/img/services.svg' alt='services' />
        <div>
          {
...
const ServiceItem = ({ title, description, img, index, id }: any) => {
  const isOdd = index % 2 === 1;

  return <div id={id} className={isOdd ? 'mt-10 flex flex-row-reverse' : 'mt-10 flex'}>
